...
const Cta = () => {
  return (
    <section className="bg-[#A02279] px-[2rem] py-[8rem] text-[#fff] xl:mt-[5.3rem] xl:flex xl:justify-between xl:p-[10rem]">
      <div className="outline xl:mt-[8.6rem] xl:w-[41.5rem]">
