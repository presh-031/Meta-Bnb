...
const Header = () => {
  ...
  return (
    <>
      <header className="mx-auto mb-[2.5rem] flex w-[100%] max-w-[1440px] items-center  justify-between bg-white px-[1rem] py-[2rem] shadow-md  max-[280px]:flex-col max-[280px]:gap-[1rem] sm:shadow-none xl:mb-0 xl:px-[6.94%] xl:py-[4.3rem]">
