...
const Hero = () => {
  return (
    <>
      <section className=" outline xl:mx-[10rem]  xl:mt-[8.2rem] xl:flex xl:justify-between">
        <div className="mx-[2rem] outline xl:mx-0 xl:w-[64.6rem]">
          <p className="mb-[3.8rem] text-[4.6rem] font-normal leading-[6.84rem] text-[#434343] outline xl:mb-[4.8rem] xl:text-[5.6rem] xl:leading-[7.84rem]">
            Rent a{" "}
            <span
          ...
          <p className="mb-[2.8rem] text-[2rem] font-normal leading-[3rem] text-[#434343] outline xl:mb-[4.8rem] xl:w-[98.5%] xl:text-[2.4rem] xl:leading-[3.5rem]">
          ...
          <div className=" border-[5px] border-red-800 xl:flex xl:h-[5.4rem] xl:overflow-hidden xl:rounded-[.8rem]">
            <input
              type="text"
              className="mb-[1rem]  block h-[4.90rem] w-[100%] rounded-[0.80rem] border-[1px] border-solid border-[#A3A3A3] px-[1.5rem]  text-[1.4rem] font-normal leading-[1.82rem] outline-none placeholder:text-[#B8B8B8] xl:mb-0 xl:h-[100%] xl:rounded-none xl:border-r-0"
