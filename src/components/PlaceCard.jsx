...
const PlaceCard = ({ product }) => {
  return (
    <div className="mx-auto h-fit w-fit rounded-[1.5rem] border-[1px] border-[#D7D7D7] p-[1.6rem]">
      <div>
      ...
      <p className="mb-[0.9rem] flex justify-between text-center text-[1.2rem] font-normal leading-[1.32rem] outline">
